# 🚀 Aurorahuset Astro 2025

<img src="https://raw.githubusercontent.com/arthelokyo/.github/main/resources/astrowind/lighthouse-score.png" align="right"
     alt="AstroWind Lighthouse Score" width="100" height="358">

**Aurorahuset** is a modern website built using **[Astro 5.0](https://astro.build/) + [Tailwind CSS](https://tailwindcss.com/)** with **[Decap CMS](https://decapcms.org/)** integration, ready for deployment on **[Cloudflare Pages](https://pages.cloudflare.com/)**. Based on the popular AstroWind template with additional CMS capabilities.

## 🎯 Features

- ✅ **Astro 5** - Latest version with modern web features
...
- ✅ **Cloudflare Pages** - Ready for deployment with optimal performance
- ✅ **Production-ready** scores in **PageSpeed Insights** reports
- ✅ **Fast and SEO friendly blog** with automatic **RSS feed**, **MDX** support
